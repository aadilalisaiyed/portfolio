    ...
    <section id="home" className="relative w-full bg-[#FA3100] flex flex-col md:block md:h-screen md:overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col px-6 pt-4 pb-12 gap-6 flex-1 justify-start md:absolute md:inset-0 md:z-10 md:px-12 md:pb-[8%] md:pt-24 md:flex-row md:justify-between md:items-end md:gap-8">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full relative z-20">
          ...
          <h1
            data-aos="fade-up"
            className="text-white text-xl sm:text-3xl md:text-5xl font-black mb-3 tracking-tight leading-[1.15] w-full"
          >
            {heroContent.greeting}, <br />
            <span className="text-transparent [-webkit-text-stroke:1px_black] md:[-webkit-text-stroke:1.5px_black] text-2xl sm:text-4xl md:text-6xl font-black block mt-1">
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-white text-xs sm:text-sm md:text-lg font-semibold mb-5 md:mb-8 max-w-md drop-shadow-md leading-relaxed"
          >
          ...
          >
            ...
            <a
              ...
              className="px-4 py-2 md:px-6 md:py-2.5 text-[11px] sm:text-xs md:text-base rounded-full bg-white text-black font-bold hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 shadow-md uppercase tracking-wider"
            >
            ...
            <a
              ...
              className="px-4 py-2 md:px-6 md:py-2.5 text-[11px] sm:text-xs md:text-base rounded-full bg-black/40 border border-white/20 text-white font-bold hover:bg-black/60 transition-all duration-300 backdrop-blur-md uppercase tracking-wider"
            >
            ...
            <a
              ...
              download
              className="px-4 py-2 md:px-6 md:py-2.5 text-[11px] sm:text-xs md:text-base rounded-full bg-transparent border border-white/30 text-white font-bold hover:bg-white hover:text-black transition-all duration-300 backdrop-blur-md flex items-center gap-1.5 uppercase tracking-wider"
            >
        ...
        >
          <div className="w-10 h-10 md:w-20 md:h-20 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#ff2a2a] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_40px_rgba(255,42,42,0.6)]">
            {!isPlaying || isMuted ? (
              ...
              // Pause Icon
              <svg className="w-4 h-4 md:w-8 md:h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z" />
              </svg>
            )}
          </div>
          <span className="text-white text-[9px] md:text-xs font-bold tracking-widest uppercase opacity-70 group-hover:opacity-100 transition-opacity">
